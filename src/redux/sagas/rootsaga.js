...
import { generateUserStories, getUserStories, deleteUserStory, addUserStory, updateUserStory } from '../slices/userStories'
import {handleGenerateUserStories, handleGetUserStories, handleDeleteUserStory,
        handleAddUserStory, handleUpdateUserStory} from './handlers/userStories'
...
export function* watcherSaga() {
        ...
        yield takeLatest(updateUserStory.type, handleUpdateUserStory);
